---
title: 'Assignment A03: LEGO SALES TIDYVERSE'
author: ''
date: '2021-06-04'
...
```{r warning=FALSE,echo=FALSE,message=FALSE}
 # get categories
#age_group = cut(lego_sales$age, breaks=c(0,19,26,36,51,Inf))
...
# Q4. Probability of customer from the 19 - 25 age group

cat("From the 19 - 25 age group =",129/nrow(lego_sales))


# Q5. Probability of customer from the 19 - 25 age group and purchased a Duplo theme set
...
# Q6. Probability of customer from the 19 - 25 age group given they purchased a Duplo theme set
