---
title: 'Assignment A03: LEGO SALES'
author: Raghul Mohankumar
date: '2021-06-05'
slug: assignment-a03-lego-sales
categories:
  - Tidyverse
tags: []
---
...
Probability of a random customer

```{r warning=FALSE,echo=FALSE,message=FALSE}



cat("Probability of a random customer from the 19 - 25 age group =",129/nrow(lego_sales))
...
cat("Probability of a random customer from the 19 - 25 age group and purchased a Duplo theme set =",duplo_prob$n)
...
cat("Probability of a random customer from the 19 - 25 age group given they purchased a Duplo theme set =",duplo_prob2$n)
