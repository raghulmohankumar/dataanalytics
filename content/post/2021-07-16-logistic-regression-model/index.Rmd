...
We will use train for logistic regression model building and use train_25 to test the performance of the model thus built. Lets build logistic regression model on train dataset. In this model, we can observe the following parameters , i)   Residual standard error: 0.2695 on 45179 degrees of freedom
